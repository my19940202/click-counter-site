let data = {
    ...
    "Feature": {
        ...
        "situation": {
            ...
            "content": `
                <ul>
                    <li>人数统计：会议签到、婚礼宾客统计、课堂点名</li>
                    <li>库存盘点：停车位统计、仓库货物清点、超市商品统计、图书馆书籍管理</li>
                    <li>工业计数：生产线工序计数、质量检测次数记录、设备运转周期统计</li>
                    <li>健身计数：俯卧撑计数、跳绳计数、深蹲计数、引体向上计数</li>
                    <li>体育比分统计：篮球比赛得分、乒乓球比分、羽毛球赛局数统计</li>
                </ul>
            `
        }
    }
